...
\begin{enumerate}
    ...
    \item Environment-specific fine-tuning with \gls{adc} data from HAN University R29 produced the most practically valuable \gls{yolo} improvement, substantially increasing target-domain performance while preserving original-domain performance, including better confidence on weaker detections and longer practical recognition distance for the tested outdoor single-button panel.
