...
accurately within visually dense scenes.
This observation motivates the need for vision methods that go beyond coarse
detection of panels or regions and instead support precise identification of
...
predicts a separate mask for each detected instance \citep{he2017maskrcnn}.
Figure~\ref{fig:vision_task_comparison} visualizes this distinction. For an
...
frameworks, facilitating reuse and future extensions \citep{lin2014coco}.
...
pipeline. \gls{yolo}-based segmentation models, such as the \gls{yolo}v8s segmentation model, trade a moderate
