...
domain, both in confidence and in practical recognition distance. This supports
the decision to include an \gls{adc} in the full workflow and suggests that
further fine-tuning on carefully collected deployment data is likely to remain a
high-value improvement path.
