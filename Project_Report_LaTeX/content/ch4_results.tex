...
\gls{ocr}-based button interpretation results. Unless stated otherwise, final
...
Figures~\ref{fig:stage3_mask_map} and \ref{fig:stage3_val_seg_loss} show the two
Stage 3 refinement runs. Their trajectories are nearly identical, indicating
that the refinement stage was stable once the strongest Stage 2 configuration
had been selected.
