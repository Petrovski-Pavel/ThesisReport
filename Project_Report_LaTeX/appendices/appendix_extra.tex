...
\section{Baseline YOLOv8-Seg versus final Mask R-CNN}
\label{app:yolo_vs_maskrcnn}

A direct cross-architecture comparison was performed between the baseline
\gls{yolo}v8-Seg checkpoint and the final 1400-image \gls{maskrcnn}
...
\begin{table}[htbp]
    \centering
    \caption{Supplementary comparison between the baseline \gls{yolo}v8-Seg and
...
\gls{yolo}v8-Seg model provided substantially higher thresholded precision and
...
while \gls{yolo}v8-Seg remained the preferred deployment-oriented detector due to
